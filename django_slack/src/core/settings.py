...
SECRET_KEY = 'django-insecure-7)58l)!o43#au!7pbsgnm!-s1jf452sd+_-(2386w6e7^n_+(*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['horribly-feasible-oriole.ngrok-free.app']
# https://docs.djangoproject.com/en/5.1/ref/settings/#csrf-trusted-origins
CSRF_TRUSTED_ORIGINS = ['https://horribly-feasible-oriole.ngrok-free.app']
